...
INSERT INTO "new_User" ("createdAt", "email", "id", "name", "password", "profilePicUrl", "updatedAt") SELECT "createdAt", "email", "id", "name", "password", "profilePicUrl", "updatedAt" FROM "User";
DROP TABLE "User";
